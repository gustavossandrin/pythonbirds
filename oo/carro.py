...
class Direcao:
    ...
    def girar_a_direita(self):
        dct_de_valores = {NORTE: LESTE, LESTE: SUL, SUL: OESTE, OESTE: NORTE}
        self.valor = dct_de_valores[self.valor]

    def girar_a_esquerda(self):
        dct_de_valores = {NORTE: OESTE, OESTE: SUL, SUL: LESTE, LESTE: NORTE}
        self.valor = dct_de_valores[self.valor]
